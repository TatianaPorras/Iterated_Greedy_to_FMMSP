...
\vspace{\baselineskip}
Los cuatro algoritmos que han sido aplicados al modelo FMMSP son DBSA-LS, BDBSA, MBSA, e IGA. Estos cuatro algoritmos presentan variabilidad en la solución que aportan, como se puede ver en la siguiente tabla: \autocite{modFMMSP}
