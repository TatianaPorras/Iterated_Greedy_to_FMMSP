...
\vspace{\baselineskip}
\textbf{Algoritmo MNIG:} El algoritmo MNIG se entiende dividido en cuatro algoritmos, cada uno realizando un rol diferente y al ser aplicados como se indica logran una solución. \autocite{algMNIG}
...
\vspace{\baselineskip}
Esto termina la presentación del modelo FMMSP y del algoritmo MNIG. Con este marco de referencia se puede llevar a cabo el proyecto de grado.
