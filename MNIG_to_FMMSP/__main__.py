...
# tT_i_u tiene la estructura [ máquina1, máquina2, máquinaM ], a su vez cada máquina tiene la forma [trabajo1, trabajo2, trabajoN], y cada trabajo tiene la forma (tiempo_pesimista, tiempo_promedio, tiempo_optimista).

# U_s es el conjunto de máquinas o unidades de la etapa s.
U_s = [[0, 1], [2, 3, 4]]

a1 = DNEH_SMR([[1, 1, 2], [1, 1, 2], [1, 1, 2], [1, 1, 2], [1, 1, 2]], [[0, 1], [2]])
